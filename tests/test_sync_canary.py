...
class GA4SyncCanaryTest(SyncCanaryTest, GA4Base):
    ...
    def streams_to_selected_fields():
        return {
            ...
            'ecommerce_purchases_item_category_combined_report': {"date", "browser",
                                                                  "conversions", },
            ...
            'traffic_acq_session_default_channel_group_report': {"date", "browser",
                                                                 "conversions", },
            ...
            'user_acq_first_user_default_channel_group_report': {"date", "browser",
                                                                 "conversions", },
            'user_acq_first_user_google_ads_ad_group_name_report': {"date", "browser",
                                                                    "conversions", },
            'user_acq_first_user_google_ads_network_type_report': {"date", "browser",
                                                                   "conversions", },
