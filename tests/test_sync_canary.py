...
class GA4SyncCanaryTest(SyncCanaryTest, GA4Base):
    ...
    def streams_to_selected_fields(self):
        return {
            ...
            'pages_title_and_screen_class_report': { "date", "browser", "conversions", },
            ...
            'pages_path_report': { "date", "browser", "conversions", },
            'pages_title_and_screen_name_report': { "date", "browser", "conversions", },
            ...
            'traffic_acq_session_default_channel_grouping_report': { "date", "browser", "conversions", },
            'ecommerce_purchases_item_category_1_report': { "date", "browser", "conversions", },
